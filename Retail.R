...
rules <- apriori(retail, parameter = list(support = 0.04, confidence = 0.5, minlen = 2))
rules
...
windows()
plot(rules[1:27], method = "graph") # for good visualization try plotting only few rules
